...
// Same hierarchy as product-reuse-between-category: 4 products, 2 categories, modifier reuse
// Published to multiple locations instead of single location
const LOCATIONS = ['Dubai', 'Colombo'];

describe('4 products, 2 categories, modifier reuse, 1 menu to multiple locations', () => {
