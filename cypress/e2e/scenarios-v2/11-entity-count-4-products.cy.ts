/**
 * ============================================================================
 * TEST SCENARIO: Entity Count - 4 Products
 * ============================================================================
 *
 * BUSINESS RULE: Verify correct entity count mapping when publishing
 * 4 products with nested modifier chains
 *
 * TEST SETUP:
 ...
 * ✅ Menu exists in GC2
 * ✅ Total menu items = 9 (4 main + 5 from nested chains)
 * ✅ Product count in GC3 equals menu item count in GC2
 * ✅ All products correctly synced
 *
 * CLEANUP:
...
const scenario = TEST_SCENARIOS.find(s => s.id === 'entity-count-4-products');

if (!scenario) {
  throw new Error('Scenario "entity-count-4-products" not found');
}
